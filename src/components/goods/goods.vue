<template>
  <div class="goods">
    <div class="menu-wrapper" v-el:menu-wrapper>
      <ul>
        <li v-for="item in goods" class="menu-item" :class="{'current':currentIndex===$index}"
            @click="selectMenu($index, $event)" v-bind:key="item">
    ...
    <div class="foods-wrapper" v-el:food-wrapper>
      <ul>
        <li v-for="item in goods" v-bind:key="item" class="food-list food-list-hook">
          <h1 class="title">{{item.name}}</h1>
          <ul>
            <li @click="selectFood(food, $event)" v-for="food in item.foods" v-bind:key="food" class="food-item border-1px">
              <div class="icon">
